<template>
    <section id="over-mij" class="bg-white dark:bg-gray-900 py-24">
      <div class="max-w-7xl mx-auto px-6 lg:px-8 grid md:grid-cols-2 gap-16 items-center">
        <!-- Tekst -->
        <div>
          ...
          <p class="text-lg text-gray-600 dark:text-gray-300">
            Ik geef les in <strong>Hoorn</strong> en <strong>Zaandam</strong>, en spreek naast Nederlands ook vloeiend Engels en Arabisch. 
          </p>
        </div>
